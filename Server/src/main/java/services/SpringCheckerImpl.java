...
public class SpringCheckerImpl extends SpringCheckerGrpc.SpringCheckerImplBase {
    @Override
    public void giveInfoSpring (ZodiacChecker.ZodiacRequest request, StreamObserver<ZodiacChecker.ZodiacReply> responseObserver) {
        String[][] zodiac = new String[3][3];
        int zodiacBuilder = 0;
        try {
            Scanner fileReader = new Scanner(new BufferedReader(new FileReader("src/main/java/services/SpringZodiac.txt")));
